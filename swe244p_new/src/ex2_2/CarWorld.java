...
class CarWorld extends JPanel {
	...
	Toolkit toolkit = Toolkit.getDefaultToolkit();
        ...
        redCar = toolkit.getImage("src/ex2_2/image/redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("src/ex2_2/image/bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("src/ex2_2/image/bridge1.gif");
